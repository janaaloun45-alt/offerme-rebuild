...
export const offers = [
  { name: "Caribou Coffee", category: "Coffee & Bakery", perk: "20% OFF", description: "Direct 20% discount on handcrafted beverages and breakfast bakery items.", bank: "NBK Visa Platinum", tag: "AUTO-APPLIED", image: coffee, location: "0.6 km · Kuwait City Hub", savings: "KD 1.000" },
...
export function OfferCard({ offer = offers[0], detailed = false }: { offer?: typeof offers[number]; detailed?: boolean }) {
